...
public class XMLElement implements IXMLElement, Serializable {
    ...
    public IXMLElement getFirstChildNamed(String name) {
        ...
        Enumeration enam = this.children.elements();

        while (enam.hasMoreElements()) {

            IXMLElement child = (IXMLElement) enam.nextElement();
    ...
    private XMLAttribute findAttribute(String fullName) {
        ...
        Enumeration enam = this.attributes.elements();

        while (enam.hasMoreElements()) {

            XMLAttribute attr = (XMLAttribute) enam.nextElement();
